...
<body style="background-image: url('https://mdbootstrap.com/img/new/fluid/city/018.jpg');
            height: 100vh">
...
<br>
<br>
<center><h1 style="color:white;">Welcom</h1></center>
<p class="text-center" style="color:white;">Have Good Day All Admins</p>
<center><h4 style="color:white;"><%out.println(session.getAttribute("user")); %><h4></h4></center>
